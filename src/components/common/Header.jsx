...
function Header({ title, toggleMobileMenu, isMobileMenuOpen }) {
  ...
  return (
    <motion.header 
      ...
      initial="hidden"
      animate="visible"
      className="mx-2 sm:mx-4 md:mx-6 mb-6 p-4 sm:p-5 flex justify-between items-center sticky top-2 z-45 rounded-xl slide-in-top"
      style={{
        ...modernStyle,
    ...
    >
      <div className="flex items-center">
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
          className="w-12 h-12 rounded-xl mr-4 flex items-center justify-center shadow-md transition-smooth"
          style={{ 
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="p-2.5 rounded-lg bg-gray-50 hover:bg-gray-100 transition-smooth hover-lift"
          title="Notifikasi"
        >
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
          className="p-1.5 rounded-lg bg-gray-50 hover:bg-gray-100 transition-smooth hover-lift"
          title="Profil"
        >
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-medium shadow-sm">
            A
          </div>
        </motion.div>
      </motion.div>
      ...
      {isMobile && (
        <motion.button
          ...
          className="p-3 rounded-lg text-white shadow-md z-50 transition-smooth"
          style={{ 
            background: `linear-gradient(135deg, ${theme.primary}, ${theme.accent})`,
            willChange: 'transform',
            transform: 'translateZ(0)',
